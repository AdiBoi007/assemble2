        ...
        >
            ...
            <div className="mb-6 flex items-center justify-between z-10 shrink-0">
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-white/10 border border-white/30 flex items-center justify-center shadow-[0_0_15px_rgba(99,102,241,0.2)]">
                    ...
                    <div>
                        ...
                        <div className="text-[11px] font-mono text-zinc-300/80 uppercase tracking-widest mt-0.5">Global Data Sync: {data.status}</div>
                    </div>
                </div>
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar pr-3 pb-8 space-y-4">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-3 gap-3">
                    {data.integrations.map((tool, i) => {
                        ...
                        return (
                            <div key={i} className="p-4 rounded-xl bg-zinc-800 border border-white/10 flex flex-col justify-between hover:border-white/30 transition-all group relative overflow-hidden">
                                <div className="absolute top-0 right-0 w-24 h-24 bg-white/5 rounded-full blur-[20px] -translate-y-1/2 translate-x-1/2 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity" />

                                <div className="flex items-center justify-between mb-4 relative z-10">
                                    <div className="w-8 h-8 rounded border border-white/10 bg-white/5 flex items-center justify-center group-hover:bg-white/10 group-hover:border-white/30 transition-colors">
                                        {iconSlug ? (
                                    ...
                                    <span className="text-[8px] uppercase font-bold tracking-widest px-2 py-0.5 rounded border border-white/20 bg-white/10 text-zinc-300 flex items-center gap-1">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="flex items-center justify-between mt-2">
                                        ...
                                        <span className="text-[9px] font-mono text-zinc-300/60 uppercase">{tool.sync}</span>
                                    </div>
                                </div>
                            </div>
                        )
