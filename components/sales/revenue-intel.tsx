            ...
            <div className="mb-6 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-[11px] text-[#FF6B00]/80 font-mono uppercase tracking-widest mt-0.5">Stripe Metrics Synced</p>
                    </div>
                </div>
            </div>

            <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="p-6 rounded-2xl bg-[#FF6B00]/5 border border-[#FF6B00]/20 relative overflow-hidden">
                    ...
                    <div className="text-[10px] font-bold tracking-widest uppercase text-[#FF6B00]/70 mb-2 relative z-10">Current MRR</div>
                    <div className="text-4xl font-black tracking-tighter text-white mb-2 relative z-10">{data.currentMRR}</div>
                    <div className="text-[10px] font-bold tracking-widest uppercase text-emerald-400 relative z-10 bg-emerald-500/10 inline-block px-2 py-1 rounded">{data.mrrDelta}</div>
                </div>
                <div className="p-6 rounded-2xl bg-black border border-white/10 relative overflow-hidden shadow-inner">
                    ...
                    <div className="text-[10px] font-bold tracking-widest uppercase text-orange-400 bg-orange-500/10 inline-block px-2 py-1 rounded">{data.churnNote}</div>
                </div>
            </div>
                ...
                {pipelineStages.map(([stage, count], i) => (
                    <div key={stage} className="flex-1 bg-white/[0.02] border border-white/[0.05] rounded-2xl p-4 flex flex-col group hover:bg-white/[0.04] transition-colors relative overflow-hidden">
                        ...
                        <div className="text-[10px] font-bold tracking-widest uppercase text-white/50 mb-4 flex items-center justify-between">
                            {stage}
                            <span className="w-5 h-5 rounded flex items-center justify-center bg-black border border-white/10 text-[#FF6B00]">{count}</span>
                        </div>
