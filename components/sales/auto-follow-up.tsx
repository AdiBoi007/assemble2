        ...
        >
            ...
            <div className="mb-6 flex items-center justify-between z-10 shrink-0">
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-[#FF6B00]/10 border border-[#FF6B00]/30 flex items-center justify-center shadow-[0_0_15px_rgba(255,107,0,0.2)]">
                        <Timer className="w-5 h-5 text-[#FF6B00]" />
                    </div>
                    <div>
                        <h2 className="text-lg font-bold tracking-tight text-white">Auto-Follow-Up Engine</h2>
                        <div className="text-[11px] font-mono text-[#FF6B00]/80 uppercase tracking-widest mt-0.5">Drip Sequences Active</div>
                    </div>
                </div>
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar pr-3 pb-8 space-y-4">
                ...
                <div className="grid grid-cols-3 gap-3">
                    <div className="p-4 rounded-xl bg-[#050505] border border-white/10 flex flex-col items-center justify-center text-center">
                    ...
                    <div className="p-4 rounded-xl bg-[#FF6B00]/5 border border-[#FF6B00]/20 flex flex-col items-center justify-center text-center relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-16 h-16 bg-[#FF6B00]/10 rounded-full blur-[20px] -translate-y-1/2 translate-x-1/2" />
                        <ReplyAll className="w-4 h-4 text-[#FF6B00] mb-2 relative z-10" />
                        <span className="text-2xl font-black text-white relative z-10">{data.replyRate}</span>
                        <span className="text-[9px] font-bold tracking-widest uppercase text-[#FF6B00]/60 mt-1 relative z-10">Avg Reply Rate</span>
                    </div>
                    <div className="p-4 rounded-xl bg-emerald-500/5 border border-emerald-500/20 flex flex-col items-center justify-center text-center relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-16 h-16 bg-emerald-500/10 rounded-full blur-[20px] -translate-y-1/2 translate-x-1/2" />
                        <CalendarCheck className="w-4 h-4 text-emerald-400 mb-2 relative z-10" />
                        <span className="text-2xl font-black text-white relative z-10">{data.meetingsBooked}</span>
                        <span className="text-[9px] font-bold tracking-widest uppercase text-emerald-400/60 mt-1 relative z-10">Meetings Booked</span>
                    </div>
                </div>
                        ...
                        {data.liveThread.map((thread, i) => (
                            <div key={i} className="flex flex-col p-4 rounded-xl bg-white/[0.02] border border-white/5 hover:border-white/20 transition-colors gap-3">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        <div className="w-10 h-10 rounded-full bg-[#121212] flex items-center justify-center text-xs font-bold text-white/70 uppercase border border-white/10">
                                    ...
                                    <div className="flex flex-col items-end gap-1">
                                        <span className={cn(
                                            ...
                                            thread.sentiment === "Neutral" ? "bg-white/5 border-white/10 text-white/50" :
                                                thread.sentiment === "Warming" ? "bg-yellow-500/10 border-yellow-500/20 text-yellow-500" :
                                                    "bg-[#FF6B00]/10 border-[#FF6B00]/30 text-[#FF6B00] shadow-[0_0_10px_rgba(255,107,0,0.2)]"
                                        )}>
