        ...
        >
            <div className="mb-6 flex items-center justify-between z-10 shrink-0">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <div className="text-[11px] font-mono text-zinc-300/80 uppercase tracking-widest mt-0.5">Active Extraction</div>
                    </div>
                </div>
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar pr-3 pb-8 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="p-4 rounded-2xl bg-zinc-800 border border-white/10 flex flex-col justify-between shadow-inner">
                        ...
                        {data.hotLeads.map((lead, i) => (
                            <div key={i} className="flex flex-col p-4 rounded-xl bg-white/[0.02] border border-white/5 hover:border-[#FF6B00]/30 transition-colors group gap-3">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        <div className="w-10 h-10 rounded-full bg-zinc-800 border border-white/10 flex items-center justify-center text-xs font-bold text-white/70 uppercase">
                                    ...
                                    <div className="flex flex-col items-end gap-1">
                                        <span className="text-[10px] uppercase font-bold tracking-widest text-zinc-300 bg-zinc-800/10 px-2 py-0.5 rounded border border-[#FF6B00]/20">
                                            {lead.intent} Intent
                                        </span>
                                ...
                                <div className="pl-13">
                                    <div className="text-[11px] text-white/60 bg-white/5 p-2 rounded border-l-2 border-[#FF6B00] leading-relaxed">
                                        <span className="text-zinc-300 font-bold mr-1">Trigger:</span>
                                        {lead.trigger}
                                    </div>
                                </div>
                            </div>
