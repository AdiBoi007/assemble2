        ...
        >
            ...
            <div className="mb-6 flex items-center justify-between z-10 shrink-0">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <div className="text-[11px] font-mono text-[#FF6B00]/80 uppercase tracking-widest mt-0.5">{data.analysisType}</div>
                    </div>
                </div>
                <div className="px-3 py-1.5 rounded bg-emerald-500/10 border border-emerald-500/20 text-[10px] font-bold uppercase tracking-widest text-emerald-400 flex flex-col items-end">
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar pr-3 pb-8 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="p-4 rounded-2xl bg-[#050505] border border-white/10 shadow-inner flex flex-col justify-between">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className={cn(
                                        ...
                                        rec.change === "Hold" ? "bg-white/5 border-white/10 text-white/60" :
                                            rec.change.includes("Increase") ? "bg-[#FF6B00]/10 border-[#FF6B00]/20 text-[#FF6B00]" :
