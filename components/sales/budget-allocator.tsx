            ...
            <div className="mb-6 flex items-center justify-between z-10">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <div className="text-[11px] font-mono text-[#FF6B00]/80 uppercase tracking-widest mt-0.5">Capital Efficiency Active</div>
                    </div>
                </div>
                <div className="px-3 py-1.5 rounded bg-white/5 border border-white/10 text-[10px] font-bold uppercase tracking-widest text-white/50 flex flex-col items-end">
                    Runway <span className="text-[#FF6B00]">{data.runwayRemaining}</span>
                </div>
            </div>
                    ...
                    <div className="flex justify-between items-end h-24 mb-2">
                        ...
                        <div className="flex flex-col items-center w-1/3">
                            ...
                            <div className="w-full relative px-2">
                                ...
                                <div className="absolute bottom-8 w-[calc(100%-1rem)] h-[1px] bg-[#FF6B00]/50" />
                            </div>
                            <div className="text-sm font-bold text-[#FF6B00] mt-2">{data.projections.day30}</div>
                        </div>
                        {/* Day 60 */}
                        <div className="flex flex-col items-center w-1/3">
                            ...
                            <div className="w-full relative px-2">
                                ...
                                <div className="absolute bottom-12 w-[calc(100%-1rem)] h-[1px] bg-[#FF6B00]/60" />
                            </div>
                            <div className="text-sm font-bold text-[#FF6B00] mt-2">{data.projections.day60}</div>
                        </div>
                        {/* Day 90 */}
                        <div className="flex flex-col items-center w-1/3">
                            ...
                            <div className="w-full relative px-2">
                                ...
                                <div className="absolute bottom-16 w-[calc(100%-1rem)] h-[2px] bg-[#FF6B00] shadow-[0_0_8px_rgba(255,107,0,1)]" />
                            </div>
                    ...
                    <div className="space-y-3">
                        {data.budgetSplits.map((split, i) => (
                            <div key={i} className="flex items-center justify-between p-3 rounded-xl bg-white/[0.02] border border-white/5 hover:border-[#FF6B00]/30 transition-colors group">
                                <div className="flex items-center gap-3">
                                    <div className="w-8 h-8 rounded bg-black border border-white/10 flex items-center justify-center text-[10px] font-bold text-[#FF6B00]">
                                        {split.allocation}
                                    </div>
                                ...
                                <div className="flex items-center gap-6">
                                    ...
                                    <div className="flex flex-col items-end w-12 text-right">
                                        ...
                                        <div className="text-[11px] font-bold text-emerald-400 tracking-widest flex items-center gap-0.5">
